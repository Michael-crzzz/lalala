              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    buildTeamMember(Icons.person, 'Campo, Ma. Shenel L.', 'Member'),
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: const Column(
                            children: [
                              Icon(Icons.email, color: Color.fromARGB(255, 129, 97, 75), size: 32),
                              SizedBox(height: 8),
                              Text('Email', style: TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 4),
                              Text('mandapwetherel@gmail.com', 
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: const Column(
                            children: [
                              Icon(Icons.phone, color: Color.fromARGB(255, 129, 97, 75), size: 32),
                              SizedBox(height: 8),
                              Text('Phone', style: TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 4),
                              Text('09617586513', style: TextStyle(fontSize: 12)),
                            ],
                          ),
                        ),
                      ),
                  ...
                  Container(
                    ...
                    child: const Row(
                      children: [
                        Icon(Icons.location_on, color: Color.fromARGB(255, 129, 97, 75), size: 32),
                        SizedBox(width: 16),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              SizedBox(height: 4),
                              Text('3371 Harvard St, Brgy. Pinagkaisahan, Makati City',
                                style: TextStyle(fontSize: 12)),
                            ],
                          ),
                        ),
